         ...
         3. 지시자 
            page : JSP파일에 대한 정보를 저장 
                   ...
                   = 에러페이지 : errorPage="파일명"
                     ...
                     4) 412 : 한글변환 코드문제 (UTF-8 => UFT-8)
                     5) 400 : bad request => 전송값과 받는 변수 데이터형 틀리는 경우 
                   = JSP의 시작점 
            include : <%@ include file="" %> => <iframe>
                      ...
                      ==============================
            taglib : jsp의 단점을 보완 ====> JSTL ===> 자바 / HTML을 분리할때 사용 
                     자바 => 태그형으로 변경             ===================== MVC
                     <%                             Spring에서는 MVC만 사용한다 
                         if(조건문)                   1차 프로젝트 => MVC
                         {                          ReactJS ==> Redux

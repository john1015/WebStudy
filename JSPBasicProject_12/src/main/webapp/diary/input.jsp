	...
	<div class="container">
		...
		<div class="row">
			...
			<table class="table">
				<tbody>
					<tr>
						<td colspan="2">년도:<input type="text" size=10 class="input-sm" name="year" readonly value="<%=year%>">&nbsp;
								월:<input type="text" size=10 class="input-sm" name="month" readonly value="<%=month%>">&nbsp;
								일:<input type="text" size=10 class="input-sm" name="day" readonly value="<%=day%>">
						</td>
					</tr>
					<tr>
						<th width=10%>제목</th>

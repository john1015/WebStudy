<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--
		  자바 스크립트 : 태그를 제어 , 이벤트 처리 , 사용자 입력 제어 , 동적 페이지 , 애니메이션
		  ======= 브라우저에서 제어 (클라이언트)
		  ...
		  3) 인라인 스크립트 => 태그만 제어
		  	...
		  	=> 연산자
		  		 ...
		  		 형변환 연산자 => HTML에서 읽어오는 모든 데이터 문자열이다
		  		 				...
		  		 				문자 변환 : String(10)
		  		 				논리 변환 : Boolean("true") , Boolean(1) = true / 0이 아닌 숫자는 true
		  	=> 제어문 
		  		  조건문 : if , if~else
		  		  반복문 : for , for of
		  		  			=======
	   ...
	   문법형식)
	    ...
	    Vue3 
	   	...
	   	React : class Main extends Component
	   	 ...
	   	 제이쿼리 : 태그를 제어한느 프로그램 (태그 가지고 오는 방법)
	   	 			 값 , 속성 , CSS , 이벤트 제어
	   	 			 $('태그명').처리
	   	 			 $('아이디명').처리
	   	 			 ........... 선택자

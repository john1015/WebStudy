...
public class MemberModel {
	 ...
	 * SEX CHAR(6) BIRTHDAY VARCHAR2(10) POST NOT NULL VARCHAR2(7) ADDR1 NOT NULL
	...
	public void member_idfind_ok2(HttpServletRequest request, HttpServletResponse response) {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (Exception ex) {
		}

  ...
  <main class="container clear"> 
    <!-- main body --> 
     <div class="content"> 
       <div id="gallery">
        <figure>
          <header class="heading">총 <span style="font-size: 30px;font-weight: bold;color:green"><fmt:formatNumber value="${count }" pattern="###,###"/></span>개의 맛있는 레시피가 있습니다.</header>
        ...
        <ul>
         ...
         <c:forEach var="i" begin="${startPage }" end="${endPage }">
          <li ${i==curpage?'class=current':'' }>
           <a href="../recipe/recipe_list.do?page=${i }">${i }</a>
          </li>
         </c:forEach>

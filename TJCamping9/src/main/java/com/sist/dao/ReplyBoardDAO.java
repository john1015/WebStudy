...
public class ReplyBoardDAO {
  ...
  public static List<ReplyBoardVO> replyBoardListData(Map map)
  {
	  ...
	  {
		  System.out.println("replyBoardListData err");
		  ex.printStackTrace();
	  }
	  finally
	  {
  ...
  public static void replyBoardInsert(ReplyBoardVO vo)
  {
	  ...
	  {
		  System.out.println("replyBoardInsert err");
		  ex.printStackTrace();
	  }
	  finally
	  {
  ...
  public static int replyBoardRowCount()
  {
	  ...
	  {
		  System.out.println("replyBoardRowCount err");
		  ex.printStackTrace();
	  }
	  finally
	  {
  ...
  public static List<ReplyBoardVO> adminReplyBoardListData(Map map)
  {
	  ...
	  {
		  System.out.println("adminReplyBoardListData err");
		  ex.printStackTrace();
	  }
	  finally
	  {
  ...
  public static void adminReplyBoardInsert(int no,ReplyBoardVO vo)
  {
	  ...
	  {
		  System.out.println("adminReplyBoardInsert err");
  ...
  public static ReplyBoardVO adminReplyInfoData(int no)
  {
	  ...
	  {
		  System.out.println("adminReplyInfoData err");
		  ex.printStackTrace();
	  }
	  finally
	  {

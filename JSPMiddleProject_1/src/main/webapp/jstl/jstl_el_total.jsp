...
<%--
		...
		EL => ${값}
				  ...
				  JSTL : Tag로 자바 문법 사항을 만들었다
				  		   === 제어문 , 화면 이동 , 변수 선언 , 날짜 변환 , 숫자 변환 (format) , String 메소드 제어 (function)
				  		   		   ===============	 ======================
				  		   		   											자바에서 주로 처리 => 결과값
				  		   		   					| core

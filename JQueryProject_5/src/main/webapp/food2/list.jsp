    ...
    <div class="container">
        <div class="row">
            <div class="text-center">
                ...
                <input type="button" class="btn btn-lg btn-warning typeBtn" value="일식" onclick="change(4)"> 
                <input type="button" class="btn btn-lg btn-info typeBtn" value="분식" onclick="change(5)"> 
            </div>
        </div>
        ...
        <div style="height:10px"></div>
        <div class="row" id="print-pagination">
            <div class="text-center">

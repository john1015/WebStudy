...
<jsp:useBean id="O d" class="w com.sist.manager.GoodsD"></jsp:useBean>
<%
    // 출력할 데이터를 출력
...
<body>
  ...
  <div class="row">
    <div class="text-center">
      <a href="../main/main.jsp?page=<%=curpage>1?curpage-1:curpage %>&mode=2" class="btn btn-sm btn-danger">이전</a>
      <%=curpage %> page / <%=totalpage %> pages
      <a href="../main/main.jsp?page=<%=curpage<totalpage?curpage+1:curpage %>&mode=2" class="btn btn-sm btn-primary">다음</a>
    </div>
  </div>
